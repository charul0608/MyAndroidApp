...
import com.example.myandroidapp.ui.view.activities.AddGarbageActivity
import com.example.myandroidapp.ui.view.Garbage
...
class FireStoreClass {
    ...
    {
        val dataRefer = FirebaseFirestore.getInstance().collection(Constants.CONSTANTS).document(
            Constants.WASTETYPEDATA)
